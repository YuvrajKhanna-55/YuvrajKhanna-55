...
I build things to understand them — not to ship fast, not to pad a portfolio. If I can't build it from scratch, I don't feel like I actually know it. That's how I learn everything.
...
| Area | Focus |
|---|---|
| **LLMs & RAG** | Hybrid retrieval pipelines — dense + sparse search, cross-encoder reranking |
| **Transformers** | Re-implementing architecture papers to understand decisions, not just APIs |
| **Deep Learning** | PyTorch from tensors up — autograd, custom loops, optimization |
| **Computer Vision** | Transfer learning, class imbalance, DenseNet & ViT architectures |
| **Backend for AI** | FastAPI services, Streamlit interfaces, making ML models usable |
...
<img height="180em" src="https://github-readme-stats.vercel.app/api/top-langs/?username=YuvrajKhanna-55&layout=compact&theme=github_dark&hide_border=true&bg_color=0d1117&title_color=58A6FF&text_color=c9d1d9&langs_count=8" />
...
- 📄 Re-implementing *Attention Is All You Need* — Vaswani et al.
